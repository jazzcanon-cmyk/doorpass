...
export async function POST(request: Request) {
  try {
    ...
    console.error("[admin/users:create] 처리 실패:", (error as Error).message)
...
export async function GET(request: Request) {
  try {
    ...
    console.error("[admin/users:list] 처리 실패:", (error as Error).message)
    return NextResponse.json({ error: "서버 오류가 발생했습니다." }, { status: 500 })
  }
}
...
export async function PATCH(request: Request) {
  try {
    ...
    console.error("[admin/users:patch] 처리 실패:", (error as Error).message)
    return NextResponse.json({ error: "서버 오류가 발생했습니다." }, { status: 500 })
  }
}
...
export async function DELETE(request: Request) {
  try {
    ...
    console.error("[admin/users:delete] 처리 실패:", (error as Error).message)
    return NextResponse.json({ error: "서버 오류가 발생했습니다." }, { status: 500 })
  }
}
