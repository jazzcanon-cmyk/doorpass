...
export function SelectedBuildingInfo({ building, passwordAccess, onClose, onPasswordUpdate }: SelectedBuildingInfoProps) {
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-3 flex flex-col gap-2">
              {passwordAccess !== "full" ? (
                <div className="flex flex-wrap items-start gap-2">
                  <BuildingPasswordDisplay access={passwordAccess} password={building.password} variant="panel" />
            ...
            {passwordAccess === "full" && !canEdit && !isEditing && (
