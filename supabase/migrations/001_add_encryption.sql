...
SET password_encrypted = pgp_sym_encrypt(
  password,
  '409c1c40f3e805854d40d467acc53c7b0841c0c74d9bc597e08adb154ae02a60'  -- ⚠️ 반드시 변경하세요!
)
...
BEGIN
  RETURN pgp_sym_decrypt(
    ...
    '409c1c40f3e805854d40d467acc53c7b0841c0c74d9bc597e08adb154ae02a60'  -- ⚠️ 동일한 키 사용!
  );
END;
